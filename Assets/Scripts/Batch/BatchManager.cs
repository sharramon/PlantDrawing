...
namespace TiltBrush
{
    ...
    public class BatchManager
    {
        ...
        public SimpleCanvas Canvas { get { return m_owner; } }
        ...
        public void Init(SimpleCanvas owner)
        {
        ...
        public void Update()
        {
            ...
            {
                pool.TrimBatches();
                if (SimpleAppConfig.Instance.EnableBatchMemoryOptimization)
                {
